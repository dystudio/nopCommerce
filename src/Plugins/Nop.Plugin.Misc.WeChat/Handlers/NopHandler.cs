...
namespace Nop.Plugin.Misc.WeChat.Handler
{
    ...
    /// </summary>
    public partial class NopMessageHandler : MessageHandler<NopMessageContext>
    {
        /*
        ...
        public NopMessageHandler(Stream inputStream, PostModel postModel, int maxRecordCount = 0)
        ...
        public NopMessageHandler(RequestMessageBase requestMessage)
            : base(requestMessage)
        {
        }
