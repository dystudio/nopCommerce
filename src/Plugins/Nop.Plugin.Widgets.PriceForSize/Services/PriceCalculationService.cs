      ...
      catalogSettings
            ...
            out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            if (ps != null && ps.HasPriceForSize)
            {
                ...
                var standardPrice = base.GetUnitPrice(product, customer, shoppingCartType, quantity, attributesXml, customerEnteredPrice, rentalStartDate, rentalEndDate, includeDiscounts, out discountAmount, out appliedDiscounts);
