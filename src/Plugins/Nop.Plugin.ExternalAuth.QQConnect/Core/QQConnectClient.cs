...
namespace Nop.Plugin.ExternalAuth.QQConnect.Core
{
	...
	{
		public QQConnectClient(string clientId, string clientSecret) : base(clientId, clientSecret)
		{
		}

		public QQConnectClient(string clientId, string clientSecret, params string[] requestedScopes) : base(clientId, clientSecret, requestedScopes)
		{
		}
